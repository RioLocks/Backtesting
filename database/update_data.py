...
async def update_data():
    tf_ms = json.load(open('database/tf_ms.json'))  # Chargement des données de timeframes
    exchange_limit = json.load(open('database/exchange_limit.json'))  # Chargement des limites d'échange
    ...
    for exchange_name in exchange_limit:
        ...
        for tf_folder in os.listdir("database/Binance"):  # Parcourir chaque sous-dossier dans le répertoire "Binance"
            ...
            dir_path = f'database/Binance/{tf_folder}'
